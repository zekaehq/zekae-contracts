...
contract L2SlpxTest is Test {
    address public constant OWNER = 0x92ED8846C111519Fe49180e6DaADdE86Cf597E38;
    address public constant USER = 0x92ED8846C111519Fe49180e6DaADdE86Cf597E38;
    address public constant DOT_OWNER = 0x92ED8846C111519Fe49180e6DaADdE86Cf597E38;
    ...
    function setUp() public {
        ...
        oracle = new SimpleOracle(OWNER, address(l2Slpx), address(veth));
        oracle.setLatestAnswer(1826e18);
        zusd = new zUSD(OWNER);
        vault = new ZekaeVault(address(veth), address(zusd), address(l2Slpx), address(oracle), address(USER));
    ...
    function test_deposit() public {
        vm.startPrank(USER);
        l2Slpx.createOrder{value: 10 ether}(address(0), 10 ether, L2Slpx.Operation.Mint, "meme");
        veth.approve(address(vault), 1e18);
        vault.deposit(1e18);
        vm.stopPrank();
        assertEq(vault.addressToDeposit(USER), 1e18);
    }
    ...
    function test_mint() public {
        ...
        vault.mint(100e18);
        vm.stopPrank();
        assertEq(vault.addressToMinted(USER), 100e18);
    }
}                   